...
from loggingeg import response
...
def generate_explantaion(topic):
    chain = prompt | llm | parser
    response = chain.invoke({"topic":topic})
    return response

# 5.Run dynamically for any topic
user_topic = input("Enter your topic you want me to explain: ").strip()
response = generate_explantaion(user_topic)

print("\n---Mistral Response---")
print(response)


# 6.Log out the prompt and output
